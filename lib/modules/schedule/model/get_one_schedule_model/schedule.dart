...
class Schedule {
  ...
  @override
  String toString() {
    return 'Schedule(id: $id, idTeacher: $idTeacher, idLabRoom: $idLabRoom, subject: $subject, scheduleClass: $scheduleClass, date: $date, beginTime: $beginTime, endTime: $endTime, status: $status, createdAt: $createdAt, updatedAt: $updatedAt, teacher: $teacher, labRoom: $labRoom)';
  }
